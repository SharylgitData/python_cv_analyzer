...
your task is to evaluate the resume against the provided job 
description. give me the rank from 0 to 10 based on the resume match with the job description, where 0 is no match and 10 is 100% match
 if the resume matches the job description. First the output should come as rank 
